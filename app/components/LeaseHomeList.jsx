...
export var LeaseHomeList = React.createClass({
  render: function () {
...
//      return TodoAPI.filterTodos(todos, showCompleted, searchText, showSale, showBuy, showRent, showLease).map((todo) => {
    return TodoAPI.filterTodos(todos, showCompleted, searchText, showSale, showOnlyBuy, showRent, showLease, 'lease').map((todo) => {
        return (
